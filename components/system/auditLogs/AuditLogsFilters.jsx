  ...
  return (
    <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-slate-100 p-4 flex flex-col md:flex-row md:items-end gap-3">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-slate-300">Date, user, module and action type for dynamic logs.</p>
      </div>
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div className="space-y-1">
          <Label className="text-[11px] text-slate-200">User</Label>
          <Input
            type="text"
        ...
        <div className="space-y-1">
          <Label className="text-[11px] text-slate-200">Module</Label>
          <Input
            type="text"
            placeholder="Module"
            className="h-8 text-xs bg-slate-900/40 border-slate-600"
        ...
        <div className="space-y-1">
          <Label className="text-[11px] text-slate-200">Action</Label>
          <Input
            type="text"
