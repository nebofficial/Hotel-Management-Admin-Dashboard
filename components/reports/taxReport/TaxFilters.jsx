...
export function TaxFilters({ startDate, endDate, taxType, onChangeStart, onChangeEnd, onChangeTaxType, onReset }) {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-slate-100 p-4 flex flex-col md:flex-row md:items-end gap-3">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-slate-300">Date range and tax type for dynamic report updates.</p>
      </div>
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div className="space-y-1">
          <Label className="text-[11px] text-slate-200">Tax Type</Label>
          <select
