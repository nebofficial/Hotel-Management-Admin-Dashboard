...
export function ExpenseFilters({ startDate, endDate, category, department, onChangeStart, onChangeEnd, onChangeCategory, onChangeDepartment, onReset }) {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-slate-100 p-4 flex flex-col md:flex-row md:items-end gap-3">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-slate-300">Date range, department and category for dynamic reports.</p>
      </div>
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div className="space-y-1">
          <Label className="text-[11px] text-slate-200">Category</Label>
          <select
            className="h-8 text-xs bg-slate-900/40 border border-slate-600 rounded-md px-3 min-w-[120px] text-slate-100"
            value={category || 'all'}
        ...
        <div className="space-y-1">
          <Label className="text-[11px] text-slate-200">Department</Label>
          <select
            className="h-8 text-xs bg-slate-900/40 border border-slate-600 rounded-md px-3 min-w-[120px] text-slate-100"
        ...
        <Button
          ...
          size="sm"
          variant="outline"
          className="h-8 text-[11px] border-slate-500 text-slate-100 hover:bg-slate-700/60"
          onClick={onReset}
        >
          Last 30 days
        </Button>
