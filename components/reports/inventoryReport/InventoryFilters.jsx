...
export function InventoryFilters({ startDate, endDate, category, onChangeStart, onChangeEnd, onChangeCategory, onReset, categories = [] }) {
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-slate-100 p-4 flex flex-col md:flex-row md:items-end gap-3">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-slate-300">Date range and category for dynamic report updates.</p>
      </div>
