  ...
  return (
    <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-slate-100 p-4 flex flex-col md:flex-row md:items-end gap-3">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-slate-300">Date range and department for dynamic performance insights.</p>
      </div>
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div className="space-y-1">
          ...
          <select
            className="h-8 text-xs bg-slate-900/40 border border-slate-600 rounded-md px-3 min-w-[140px] text-slate-100"
