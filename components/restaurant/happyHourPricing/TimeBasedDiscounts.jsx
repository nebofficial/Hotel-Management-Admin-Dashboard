...
export default function TimeBasedDiscounts({ rules, onSave, loading }) {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" disabled={loading} className="w-full">
            {loading ? 'Creating...' : 'Create Time-Based Discount'}
          </Button>
        </form>

        {rules && rules.length > 0 && (
          <div className="mt-6 space-y-2">
            <h4 className="text-sm font-semibold">Active Time-Based Rules</h4>
