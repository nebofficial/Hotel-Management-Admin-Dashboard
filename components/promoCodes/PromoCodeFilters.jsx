...
export function PromoCodeFilters({ code, status, onChangeCode, onChangeStatus, onReset }) {
  return (
    <div className="rounded-2xl bg-gradient-to-r from-sky-900 via-sky-800 to-slate-900 text-sky-50 p-4 flex flex-col lg:flex-row lg:items-end gap-3">
      <div className="flex-1">
        ...
        <p className="text-[11px] text-sky-100/90">Filter by code and status.</p>
      </div>
      <div className="flex flex-wrap gap-3 items-end">
        <div className="space-y-1">
          <Label className="text-[11px] text-sky-50">Promo Code</Label>
          <Input
            type="text"
